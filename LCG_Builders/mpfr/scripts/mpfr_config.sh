...
LOCAL_src=${LOCAL_dest}/mpfr-${LCG_package_config_version}
...
cd ${LOCAL_build}
CFLAGS="${LCG_extra_cflags}" ${LOCAL_src}/configure --srcdir=${LOCAL_src} --prefix=${LOCAL_install} ${LCG_mpfr_config_opts}
